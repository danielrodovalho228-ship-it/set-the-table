...
import { GenerateVariationButton } from "@/components/scenario/GenerateVariationButton";
import { ShopThisLook } from "@/components/scenario/ShopThisLook";
import {
  getCurrentUser,
  getScenario,
  isFavorited,
  ...
  return (
    <article className="max-w-6xl mx-auto px-5 pt-10 pb-20">
      ...
      <header className="mt-4 grid md:grid-cols-2 gap-8 items-end">
        <div>
          ...
          <div className="mt-5 flex items-center gap-3">
            ...
            ) && <GenerateVariationButton scenarioId={scenario.id} />}
            {scenario.generated_hero_url && (
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${scenario.generated_hero_url ?? scenario.hero_image_url})`
          }}
          aria-hidden
        />
      </header>
      ...
      <section className="mt-14">
        <ShopThisLook setup={setup} scenarioSlug={scenario.slug} />
      </section>
    </article>
  );
}
